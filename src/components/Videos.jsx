...
function Videos() {
  ...
  return (
    ...
    <Stack flexDirection={['column','row']} m={['10 0 0 ','10']} min-height={'100vh'}>
      ...
      <VStack w={'full'} >
        ...
        <VStack m={10} alignItems={'flex-start'} w={'full'} p={8} overflowY={'auto'}>
          <Heading>
            Sample Video
          </Heading>

          <Text maxH={['20vh','fit-content']}>

            Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis aut quae voluptatum, nam ratione nobis quod eos enim tenetur fugit sit, ut placeat, illo quos delectus praesentium accusamus beatae ipsam at esse totam provident pariatur iure? Error temporibus et laudantium tempora vitae quae suscipit alias repellendus cumque recusandae, quis nisi, adipisci voluptatem atque odio velit. Qui aliquid earum aut blanditiis dolores. Voluptatibus veritatis eius nemo, quod iste quibusdam soluta aspernatur voluptatem error molestias enim facere cumque doloremque laudantium fuga distinctio accusantium odio neque, nostrum maiores, perferendis cum! Commodi earum odit voluptatum, aliquid tenetur minus sed incidunt possimus molestiae magni praesentium.
          </Text>
        </VStack>
      ...
      >
        ...
        {
          videosArr.map((value, index, array) => (
            <Button Button variant={'ghost'} 
            onClick={()=>setVideoSrc(value)} colorScheme={'purple'}>
              Lecture {index + 1}
            </Button>
          ))
